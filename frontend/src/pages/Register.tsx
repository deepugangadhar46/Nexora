...
import { Mail, Lock, User, ArrowRight, Eye, EyeOff, Sparkles, Github } from "lucide-react";
        ...
        <div className="w-full max-w-md">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Already have an account? <button onClick={() => navigate("/login")} className="text-pulse-600 hover:underline font-medium">Log In →</button>
            </p>
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <div className="bg-gray-900 rounded-lg p-6 mb-8 shadow-2xl">
            ...
            <pre className="text-sm text-gray-300 font-mono">
              <code>
{`import { generatePitchDeck } from '@nexora/ai';
